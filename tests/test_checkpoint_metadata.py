    ...
    def test_checkpoint_round_trip_preserves_resume_metadata(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            save_checkpoint(
                ...
                best_checkpoint_sort_key=(123.0, 0.25, 0.01, -0.9),
            )
            ...
            self.assertEqual(payload["best_checkpoint_metric_name"], "score_mae")
            self.assertEqual(payload["best_checkpoint_metric_value"], 123.0)
            self.assertEqual(payload["best_checkpoint_positions"], 11_111)
            self.assertEqual(payload["best_checkpoint_sort_key"], [123.0, 0.25, 0.01, -0.9])
